...
import ChevronUpIcon from "~icons/tabler/chevron-up";
import SelectorIcon from "~icons/tabler/selector";
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <SelectorIcon className="text-muted-foreground pointer-events-none mt-0.5 size-5" />
        }
      />
    </SelectPrimitive.Trigger>
  );
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Positioner
        ...
        className="isolate z-50 h-auto! max-h-(--available-height)"
      >
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground not-data-[variant=destructive]:focus:**:text-accent-foreground relative flex w-full cursor-default items-center justify-between gap-4 rounded-md py-1 pr-2 pl-1.5 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className,
      )}
      {...props}
    >
      ...
      <SelectPrimitive.ItemIndicator
        render={
          <span className="pointer-events-none flex size-5 items-center justify-center pt-3 pr-2">
            <CheckIcon className="text-muted-foreground pointer-events-none" />
          </span>
        }
      />
    </SelectPrimitive.Item>
